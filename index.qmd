...
#| fig.align: left
library("lazyeval")
lapply(c("knitr","dplyr","kableExtra","ggplot2","tidyverse","gt","lubridate","readODS","plotly"), require, character.only=TRUE)
```
...
# Tidy & Transform
read_csv("../data/df_tidy.csv")
dft_tidy <- read_csv("../rruiz-s.github.io/data/df_tidy.csv")
